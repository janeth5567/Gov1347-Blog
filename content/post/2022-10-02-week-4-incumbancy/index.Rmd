...
```{r  shapefile for 114th Congress, eval = FALSE, include = FALSE}
require(sf)
...
ratings_share_2018 <- read.csv("~/Desktop/Gov1347 Data/Gov1347 Projects/Gov1347-Blog/2018_ratings.csv")
...
```{r extension 1, echo = FALSE}
#Goal: make map on district level to show expert predictions vs actual vote share 
